    ...
    public Experiment buildExperiment() throws IOException {
        ...
        switch (getParameterValue("Mutation")) {
            ...
            case "displacement": //TODO
                ...
                break;
            case "simpleinversion": //TODO
                mutation = new MutationSimpleInversion<>(mutationProbability);
                break;
            case "invertionsimple": //TODO
                mutation = new MutationInsertionSimple<>(mutationProbability);
                break;
            case "inversiondisplacement": //TODO
                mutation = new MutationInversionDisplacement<>(mutationProbability);
                break;
        }
